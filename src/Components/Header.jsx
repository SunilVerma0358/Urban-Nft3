  ...
  return (
    <div className="overflow-y-scroll fixed bottom-0 left-0 top-0 xl:w-[305px] overflow-x-hidden h-full bg-[#FFFDFF] shadow-sidebarShadow ">
      <div className="xl:w-[305px] bg-[url('./assets/image/bgImgEllipse.webp')] bg-no-repeat bg-start h-[100%] bg-[#FFFDFF] px-1 sm:px-6   ">
        ...
        <Link
          to="/"
          className=" group rounded-[22.5px] flex items-center gap-4 px-[15px] leading-normal  pt-[13.5px] pb-[14.5px] duration-300 hover:bg-yellowGradiant2 lg:w-[257px]"
        >
          ...
          <p className="first-letter hidden md:block group-hover:bg-yellowGradiant text-[#7C7C7C] group-hover:text-transparent bg-clip-text duration-300  font-Inter font-semibold">
            Dashboard
          </p>
        </Link>
        ...
        <Link
          to="/Home"
          className=" group rounded-[22.5px] flex items-center gap-4 px-[15px] leading-normal mt-[15px] pt-[13.5px] pb-[14.5px] duration-300 hover:bg-yellowGradiant2 lg:w-[257px]"
        >
          <span className="flex items-center">
            <svg
              width="16"
        ...
        <Link
          to="/CardMap"
          className="group rounded-[22.5px] flex items-center gap-4 px-[15px] leading-normal mt-[15px] mb-[40px] pt-[13.5px] pb-[14.5px] duration-300 hover:bg-yellowGradiant2 lg:w-[257px]"
        >
          <span className="flex items-center">
            <svg
              width="16"
